...
<html>
<head>
    <title>Relatório RADIOPATRULHAMENTO</title>
...
<body>
<h1>CVP <span style="color: red;"> <span style="text-decoration: underline; font-weight: bold;">RELATÓRIO RADIOPATRULHAMENTO</span> </span> 18H ÀS 02H</h1>

    <?php
    $agendamentosFile = 'agendamentos2.txt';
    $vagasDisponiveisFile = 'vagas_disponiveis2.txt';
    ...
    <div class="button-container">
        <div class="button-center">
            <form method="post" action="limpar_relatorio2.php">
    ...
    <p><a href="admin2.php" class="button button-blue">Voltar para RADIOPATRULHAMENTO</a></p>
</body>
</html>
